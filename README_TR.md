...
- Zafiyet şablonları oluşturmak ve özelleştirmek için basit YAML formatı.
- Trend olan zafiyetleri ele almak için binlerce güvenlik uzmanı tarafından katkıda bulunulmuştur.
- Bir zafiyeti doğrulamak için gerçek dünya adımlarını simüle ederek hatalı pozitifleri azaltır.
...
- [**`Katkıda Bulunanlar`**](#katkıda-bulunanlar-heart) ❤
- [**`Lisans`**](#lisans)
